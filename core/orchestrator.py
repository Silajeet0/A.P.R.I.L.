...
from core.brain import AprilBrain  # Importing the new class definition
...
async def main_loop():
    ...
    # 1. Instantiate the class-based cognitive engine
    brain = AprilBrain()
    
    # 2. Fire the asynchronous boot protocol to connect to MCP and read Neo4j context
    try:
        await brain.initialize_cognitive_layers()
    except Exception as e:
        print(f"[Fatal Error] Failed to initialize MCP communication channel: {e}")
        return
    ...
    try:
            ...
            while True:
                ...
                if spoken:
                    ...
                    if "clear memory" in clean_spoken or "reset mind" in clean_spoken:
                        ...
                        # Properly targeting the instance array
                        brain.persistent_mem = [brain.persistent_mem[0]] 
                    ...
                    # 3. Await the new asynchronous thinking matrix
                    raw_answer = await brain.think(spoken)
        ...
        print("\n[System] : Command received exiting A.P.R.I.L. Bye!")
    except Exception as e:
        print(f"Error occurred: {e}")

if __name__ == "__main__":
    # 4. Drive the entire program execution inside an async execution runtime loop
